...
class checkpoint():
    def __init__(self, args):
        ...
        if not args.load:
            if not args.save:
                args.save = now
            self.dir = os.path.join('../SR/' + args.degradation + '/' + args.save) #('/home/waseem/projects/RECANv1.0/RECAN_TestCode', 'experiment', args.save)
        else:
            self.dir = os.path.join('../experiment/' + args.load) #('/home/waseem/projects/RECANv1.0/RECAN_TestCode', 'experiment', args.load)
        ...
        for d in args.data_test:
            os.makedirs(self.get_path('{}'.format(d) + '/x' + str(args.scale[0])), exist_ok=True)
    ...
    def plot_psnr(self, epoch):
        ...
        print('plot-PSNR: ',self.args.data_test, self.log)
