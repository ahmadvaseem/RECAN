...
class Data:
    def __init__(self, args):
        ...
        for d in args.data_test:
            if d in ['Set5', 'Set14', 'B100', 'Urban100', 'MScocoTiny','Manga109', 'RealSR']:
                m = import_module('data.benchmark')
                testset = getattr(m, 'Benchmark')(args, name=d, train=False) #, name=d)
...
class Data:
    def __init__(self, args):
        ...
        if args.data_test in ['Set5', 'Set14', 'B100', 'Urban100', 'Set4']:
