...
CUDA_VISIBLE_DEVICES=3 python main.py --model RECAN --save RECAN_BIX4_G5R10P192 --scale 4 --n_resgroups 5 --n_resblocks 10 --n_feats 64  --reset --chop --save_results --print_model --patch_size 192
