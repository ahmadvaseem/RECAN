...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/home/waseem/projects/RECAN/train_datasets', #'/home/waseem/projects/EDSR-PyTorch/train_datasets/',
...
parser.add_argument('--model', default='RECAN',
                    help='model name')
...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/home/waseem/projects/RECAN/train_datasets', #default='/home/yulun/data/SR/traindata/DIV2K/bicubic',
                    help='dataset directory')
parser.add_argument('--dir_demo', type=str, default='../test',
                    help='demo image directory')
parser.add_argument('--data_train', type=str, default='DIV2K',
